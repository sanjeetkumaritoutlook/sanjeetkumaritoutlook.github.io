   ...
   return (
      <div class="app-home-page">
        <p>
          ...
          </p> This website is created using <a href="https://github.com/stencil-community/stencil-app-starter" target="_blank">Stencil App Starter</a> and hosted on <a href="https://pages.github.com/" target="_blank">GitHub Pages.</a> You can use  Stencil App Starter to build entire apps all with web components using Stencil! Check out docs on{' '}
